...
/**
 * This is the main class where the Client will interact with the Server.
 * The Server will then call the specific packages and classes based on the Client's requests.
 * */
...
public class Server {
    ...
    private void run(String portNumber) {
        ...
        // HTTP Handlers for the Server Project
